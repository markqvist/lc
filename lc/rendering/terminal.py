...
class TTYRenderer:
    ...
    def _is_tty(self) -> bool: return self.mode == "tty"
    
    def write_line(self, text: str = "") -> None: self.write(text, end="\n")
    ...
    def stream_chunk(self, chunk: str) -> None:
        ...
        if self._render_markdown and self._md_streamer: self._md_streamer.ingest(chunk)
        else:                                           self.write(chunk, end="")
    ...
    def format_markdown(self, text: str) -> str:
        if self._render_markdown and self._md_formatter: return self._md_formatter.format_block(text)
        return text
